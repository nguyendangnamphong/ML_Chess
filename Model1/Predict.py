...
with open(r"C:\Users\Tuan Dung\IdeaProjects\CSCHTTT\.idea\Chess\Model1\models\heavy_move_to_int", "rb") as file:
...
model.load_state_dict(torch.load(r"C:\Users\Tuan Dung\IdeaProjects\CSCHTTT\.idea\Chess\Model1\models\TORCH_100EPOCHS.pth"))
model.to(device)
